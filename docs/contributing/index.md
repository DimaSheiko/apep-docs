...
[discussion board]: https://github.com/DimaSheiko/apep-docs/discussions
[issue tracker]: https://github.com/DimaSheiko/apep-docs/issues
[documentation]: https://github.com/DimaSheiko/apep-docs/
...
discussion board, are **well-structured**, **easy to navigate**, and
**searchable**, so you can find what you need quickly and efficiently. Thus,
...
-   :material-bug-outline: &nbsp;
    ...
    ***
    ...
    Report a bug in Apep by creating an issue with a
    reproduction
...
-   Does your comment add value to the conversation? Is it constructive and
    ...
    [Code of Conduct]: https://github.com/DimaSheiko/apep-docs/blob/master/CODE_OF_CONDUCT.md
...
**do not align** with our contribution guidelines and our [Code of Conduct].
...
[^1]:
    **Warning and blocking policy:**
    We've defined clear guidelines on how we proceed with violations:
